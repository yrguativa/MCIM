...
function App() {
  ...
  return (
    ...
    <div>
      <img src="https://convenciondemujeres.com/wp-content/uploads/2024/11/logo-1024x452.png" alt="logo Aroma" />
      <h1 className="text-2xl font-bold">Bienvenida a nuestra pre conveción de mujeres</h1>
      {!qrData && (
        <>
