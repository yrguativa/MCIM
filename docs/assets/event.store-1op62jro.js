import{aO as y,aP as E,a7 as f,a8 as m,a9 as w}from"./index-mP2OZFed.js";import{t as h,e as I}from"./toDate-KnhkpVFB.js";function D(n,e,t){const r=h(n,t?.in);return r.setTime(r.getTime()+e*I),r}const v="https://mcim-app.onrender.com/graphql",p=y.create({baseURL:v,headers:{"Content-Type":"application/json"}}),d={async getEvent(n){try{const e=`
      ...
      `,{data:t}=await p.post(v,JSON.stringify({query:e,variables:{eventId:n}}));return t.data.event}catch(e){throw e instanceof E?(console.error(e.response?.data),new Error(JSON.stringify(e.response?.data)||"Error getting ministries")):(console.error(e),new Error("Error getting ministries"))}},async getEvents(){try{const n=`
      query GetEvents {
        events {
          id
          name
