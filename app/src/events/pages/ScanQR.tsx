...
import { BadgeAlert, CalendarDays, CalendarSearch, MapPinCheckInside, Search } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto p-4">
      <Card className="p-4">
        ...
        <Card className={"p-3" + (scanData && form.formState.isValid ? " border-green-500" : "")}>
          <p className="text-sm mb-4 flex text-justify">
